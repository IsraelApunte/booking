...
import {Authorization, createLogContext, createResponse,
  getAuthorization, getSearchFilter, validAJV} from '../util/Utils';
...
export const create = async (authorizationParams: Authorization, body: Agent, context: Context) => {
  try {
    const agentService = new AgentService();
    return await agentService.create(authorizationParams, body);
  } catch (error: any) {
    console.error('----->', error);
...
export const find = async (authorizationParams: Authorization, searchFilter: SearchFilter, context: Context) => {
  try {
    const agentService = new AgentService();
    return await agentService.find(authorizationParams, searchFilter);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
...
export const findById = async (authorizationParams: Authorization, id: number, context: Context) => {
  try {
    const agentService = new AgentService();
    return await agentService.findById(authorizationParams, id);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
...
export const update = async (authorizationParams: Authorization, body: Agent, context: Context) => {
  try {
    const agentService = new AgentService();
    return await agentService.update(authorizationParams, body);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
...
export const remove = async (authorizationParams: Authorization, id: number, context: Context) => {
  try {
    ...
    // return photoServiceImpl.remove(id);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
