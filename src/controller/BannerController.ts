...
export const create = async (authorizationParams: Authorization, body: Banner, context: Context) => {
  try {
    const bannerService = new BannerService();
    return await bannerService.create(authorizationParams, body);
  } catch (error: any) {
    console.error('----->', error);
...
export const find = async (authorizationParams: Authorization, searchFilter: SearchFilter, context: Context) => {
  try {
    const bannerService = new BannerService();
    return await bannerService.find(authorizationParams, searchFilter);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
...
export const findById = async (authorizationParams: Authorization, id: number, context: Context) => {
  try {
    const bannerService = new BannerService();
    return await bannerService.findById(authorizationParams, id);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
...
export const update = async (authorizationParams: Authorization, body: Banner, context: Context) => {
  try {
    const bannerService = new BannerService();
    return await bannerService.update(authorizationParams, body);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
