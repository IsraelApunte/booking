  ...
  try {
    ...
    if (authorizationParams.group === ROLE_USER_ALPELOTEO ||
      ...
      if (httpMethod === 'GET' || httpMethod === 'DELETE') {
        ...
        if (httpMethod === 'GET' && pathParameters !== null) {
        ...
        if (httpMethod === 'GET' && queryStringParameters === null && pathParameters === null &&
...
export const create = async (authorizationParams: Authorization, body: Business, context: Context) => {
  try {
    const businessService = new BusinessService();
    return await businessService.create(authorizationParams, body);
  } catch (error: any) {
    console.error('----->', error);
...
export const find = async (authorizationParams: Authorization, searchFilter: SearchFilter, context: Context) => {
  try {
    const businessService = new BusinessService();
    return await businessService.find(authorizationParams, searchFilter);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
...
export const findById = async (authorizationParams: Authorization, id: number, context: Context) => {
  try {
    const businessService = new BusinessService();
    return await businessService.findById(authorizationParams, id);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
...
export const findByProfile = async (authorizationParams: Authorization, context: Context) => {
  try {
    const businessService = new BusinessService();
    return await businessService.findByProfile(authorizationParams);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
...
export const update = async (authorizationParams: Authorization, body: Business, context: Context) => {
  try {
    const businessService = new BusinessService();
    return await businessService.update(authorizationParams, body);
  } catch (error: any) {
    console.error('----->', error);
    error.context = createLogContext(context, error.message);
    throw error;
